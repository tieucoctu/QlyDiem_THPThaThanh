				...
				<form id="EditForm" action="#" method="post">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
								<label for="tenLop">phanlopID</label>
								<input type="text" class="form-control"name="phanlopID" placeholder="ID" />
							</div>
						</div>
						<div class="col-sm-6">
							<!-- select -->
							<div class="form-group">
								<label for="tenLop">diemtx</label>
								<input type="text" class="form-control"name="diemtx" placeholder="" />
								</select>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<!-- text input -->
							<div class="form-group">
								<label for="tenLop">diem15p</label>
								<input type="text" class="form-control"name="diem15p" placeholder="" />
								</select>
							</div>
						</div>
						<div class="col-sm-6">
							<!-- select -->
							<div class="form-group">
								<label for="tenLop">diem1t</label>
								<input type="text" class="form-control"name="diem1t" placeholder="" />
								</select>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<!-- text input -->
							<div class="form-group">
								<label for="tenLop">diemhk</label>
								<input type="text" class="form-control"name="diemhk" placeholder="" />
								</select>
							</div>
						</div>
					</div>
