...
if((empty($_SESSION['username']) && empty($_SESSION['password']))) {
	...
	if (!empty($_POST['phanlopID']) && !empty($_POST['diemtx']) && isset($_POST['diem15p']) && !empty($_POST['diem1t']) && !empty($_POST['diemhk']) && !empty($_POST['maMH']) ) {

		$phanlopID = htmlspecialchars($_POST['phanlopID']);
		$diemtx = htmlspecialchars($_POST['diemtx']) ;
		$diem15p = htmlspecialchars($_POST['diem15p']);
		$diem1t = htmlspecialchars($_POST['diem1t']);
		$diemhk = htmlspecialchars($_POST['diemhk']);
