...
<head>
	...
	<title>Hệ thống quản lý điểm trường THPT Hà Thành</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="author" content="vuiz.net">
	<meta property="og:title" content="VNEDU - Hệ thống quản lý điểm trường THPT Hà Thành" />
	<meta property="og:image" content="assets/images/logo-truong.png" />
	<meta property="og:site_name" content="" />
	<meta property="og:description" content=" Hệ thống quản lý điểm trường THPT Hà Thành" />
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="/" class="brand-link">
				...
				<span class="brand-text font-weight-light">Hà Thành </span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<!--<li class="nav-item">
							<a href="/quanly/qlDiem.php" class="nav-link">
								<i class="nav-icon fas fa-file-contract"></i>
								<p>
									Quản lý điểm test
								</p>
